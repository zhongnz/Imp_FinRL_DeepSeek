...
columns_to_load = ['Date', 'Stock_symbol', 'Qwen/Qwen2.5-72B-Instruct']
sentiment = pd.read_csv('sentiment_qwen_nasdaq_news.csv', usecols=columns_to_load)
#sentiment = pd.read_csv('sentiment_qwen_nasdaq_news_full.csv', usecols=columns_to_load)

print(sentiment.head())


columns_risk = ['Date', 'Stock_symbol', 'risk_qwen']

risk = pd.read_csv('risk_qwen_nasdaq_news.csv', usecols=columns_risk)
...
def add_sentiment(train, sentiment, column_name='Qwen/Qwen2.5-72B-Instruct'):
...
def add_risk(train, risk, column_name='risk_qwen'):
    train_new = train
    risk_new=risk
    train_new['date'] = pd.to_datetime(train_new['date'])
...
train_risk.to_csv('train_data_qwen_risk.csv')
trade_risk.to_csv('trade_data_qwen_risk.csv')
