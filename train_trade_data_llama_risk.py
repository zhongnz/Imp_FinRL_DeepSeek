...
columns_to_load = ['Date', 'Stock_symbol', 'sentiment_llama']
sentiment = pd.read_csv('sentiment_llama.csv', usecols=columns_to_load)
#sentiment = pd.read_csv('sentiment_qwen_nasdaq_news_full.csv', usecols=columns_to_load)

print(sentiment.head())


columns_risk = ['Date', 'Stock_symbol', 'risk_llama']

risk = pd.read_csv('risk_llama.csv', usecols=columns_risk)
...
def add_sentiment(train, sentiment, column_name='sentiment_llama'):
...
def add_risk(train, risk, column_name='risk_llama'):
    train_new = train
    risk_new=risk
    train_new['date'] = pd.to_datetime(train_new['date'])
...
train_risk.to_csv('train_data_llama_risk_2013_2018.csv')
trade_risk.to_csv('trade_data_llama_risk_2019_2023.csv')
